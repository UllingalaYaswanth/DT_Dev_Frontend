...
// import Tower from "../pages/TowerData";
...
//     console.log("Selected Tower Data:", tower);
...
//     if (link) {
//       navigate(link, { state: { tower: towerData } }); // Pass the tower data in the state
//     } else {
...
//   );
//   console.log("filterDocumets:",filteredDocuments)
//   const cardData = [
...
//   return (
//     <div className="mt-12 px-5 h-[82vh]">
//       {!selectedTower ? (
...
//                     <tr key={key} className="cursor-pointer hover:bg-gray-100 hover:shadow-sm">
...
//         </div>
//       ) : (
//         <Tower goBack={() => setSelectedTower(null)} towerDetails={selectedTowerDetails} />
//       )}
...
//           <h1 className="text-center font-semibold mb-5" towerDetails={selectedTowerDetails}>{towerName}</h1>
//           <div className="gap-16 py-14 items-center flex">
//             {cardData.map((data, index) => (
//               <div key={index} className="flex items-center">
//                 <img src={data.img} className="w-8 h-8 mr-2 rounded-full" alt={data.name} />
//                 {data.name === "Excel file" ? (
//                   <button
//                     onClick={() => {
//                       console.log("Navigating with tower details:", selectedTowerDetails);
//                       handlenavigate(data.link, selectedTowerDetails);
//                     }}
//                     className="text-lg text-gray-700 font-semibold hover:border-b border-gray-800"
//                   >
//                     {data.name}
//                   </button>
//                 ) : (
//                   <button className="text-lg text-gray-700 font-semibold hover:border-b border-gray-800">
//                     {data.name}
//                   </button>
//                 )}
//               </div>
//             ))}
//           </div>
//           <button className="px-3 py-1 bg-red-500 text-white mt-10 rounded-xl block mx-auto" onClick={() => setOpen(false)}>
//             Close
//           </button>
//         </div>
//       </Dialog>
...
//   return (
//     <div className="mt-12 px-5 h-screen">
//       {!selectedTower ? (
//         <div className="mb-4 mt-12 grid grid-cols-1 gap-5 xl:grid-cols-1">
//           <Card className="overflow-hidden">
//             <CardHeader floated={false} shadow={false} color="transparent" className="m-0 flex items-center justify-between p-6">
...
//   // Open the dialog and fetch the files for the selected tower
//   const HandleOpen = (tower) => {
//     setTowerName(tower.siteId);
//     setOpen(true);
//     setSelectedTowerDetails(tower);
...
//   // Handle navigation to another page (e.g., Tower Details page)
//   const handleTowerClick = (tower) => {
//     setSelectedTower(tower.siteId);
//     setSelectedTowerDetails(tower);

//     // Navigate to the tower details page and pass the tower data as state
//     navigate("/admin/home/tower-details", { state: { tower: tower } });
//   };
...
//                       <img src={data.img} className="w-8 h-8 mb-2 rounded-full" alt={data.name} />
//                       <button
//                         onClick={() => navigate(data.link, { state: { tower: selectedTowerDetails } })}
//                         className="text-blue-600 font-semibold hover:underline"
//                       >
//                         Download {data.name}
//                       </button>
